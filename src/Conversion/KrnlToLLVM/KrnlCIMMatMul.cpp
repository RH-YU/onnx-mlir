...
#define DEBUG_TYPE "krnl-cim-to-standard"
...
//     populateLoweringCIMMatMulOpPatterns(patterns, &getContext());
...
void populateLoweringCIMMatMulOpPattern(
    OwningRewritePatternList &patterns, MLIRContext *ctx) {
  patterns.insert<CimOpConversion<krnlWriteMatrixOp>,
                  CimOpConversion<krnlCIMMatMulOp>>(ctx);
}
